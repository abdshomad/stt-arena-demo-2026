"""Wav2Vec2 Large XLSR Indonesian — real HF CTC model (no punctuation/casing)."""
from engine_common import create_app, torch_device

MODEL_REPO = "indonesian-nlp/wav2vec2-large-xlsr-indonesian"
...
app = create_app(
    engine_id="indonesian-nlp-wav2vec2-large-xlsr-indonesian",
    load=load,
