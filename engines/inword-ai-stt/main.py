"""inword-ai-stt — N/A: the claimed model has no public implementation or API.
...
app = create_unavailable_app(
    engine_id="inword-ai-stt",
    reason="Inword AI STT does not correspond to any public model or API",
)
